...
class NXTopology:
    ...
    def __init__(self, number_of_servers=686, switch_graph_degree=14, number_of_links=2800, labels=['8 Shortest Paths', '8-way ECMP', '64-way ECMP']):
    ...
    def calculate_all_paths(self):
        for sender in range(len(self.sender_to_receiver)):
            ...
            self.add_to_edge_label(k_shortest_paths, '8 Shortest Paths')
...
if __name__ == "__main__":
    ...
    y_axes = {'8 Shortest Paths':t.to_y_axis('8 Shortest Paths'), '8-way ECMP':t.to_y_axis('8-way ECMP'), '64-way ECMP': t.to_y_axis('64-way ECMP')}
    # print(y_axes)
    t.draw_fig9(y_axes)
